  ...
  function () {
    ...
    function Postmate(_ref2) {
      ...
      var _ref2$container = _ref2.container,
          ...
          invalidReplyMessageCallback = _ref2.invalidReplyMessageCallback;
      // eslint-disable-line no-undef
      this.parent = window;
      this.frame = document.createElement('iframe');

      (_this$frame$classList = this.frame.classList).add.apply(_this$frame$classList, classListArray);
      ...
      return new Postmate.Promise(function (resolve, reject) {
        var reply = function reply(e) {
          if (!sanitize(e, childOrigin)) {
            if (_this4.invalidReplyMessageCallback) {
              _this4.invalidReplyMessageCallback(_this4.frame, e);
            }
